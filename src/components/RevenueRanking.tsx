    ...
    <div style={{ display:"grid", gap:6 }}>
      {rows.map((r,i)=>{
        ...
        return (
          ...
          >
            <span style={{ width:26, height:26, borderRadius:"50%", background:i<3?rankColor+"22":"transparent", border:`1px solid ${i<3?rankColor:C.border}`, color:i<3?rankColor:C.muted, display:"flex", alignItems:"center", justifyContent:"center", fontSize:12, fontWeight:800, flexShrink:0 }}>{i+1}</span>
