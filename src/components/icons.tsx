...
export const Check = I("<path d=\"M20 6 9 17l-5-5\"></path>");
export const Star = I("<path d=\"M11.5 2.3a.6.6 0 0 1 1 0l2.6 5.3 5.8.85a.6.6 0 0 1 .33 1.02l-4.2 4.1 1 5.8a.6.6 0 0 1-.87.63L12 17.3l-5.2 2.73a.6.6 0 0 1-.87-.63l1-5.8-4.2-4.1a.6.6 0 0 1 .33-1.02l5.8-.85z\"></path>");
