...
export const PLANS = [
  { id:"starter", name:"Starter", price:78000,  members:1,  color:"#4A90D9", best:false,
    ...
    features:["모델·고객사·섭외 무제한","스케줄·더블부킹 방지","3.3% 원천징수 자동계산","세무사용 엑셀·원천징수 내역서","이메일 알림 · 구글 캘린더 동기화","알림톡·대량발송 (예정)"] },
  { id:"pro", name:"Pro", price:118000, members:3,  color:"#7B68EE", best:false,
    tagline:"대표 + 직원 1~2명",
    features:["Starter 모든 기능","담당자 3명","업체별 정산 명세서","대대행 수신/발신","이메일 알림 · 구글 캘린더 동기화","알림톡·대량발송 (예정)","우선 고객 지원"] },
  { id:"team", name:"Team", price:158000, members:7,  color:"#10b981", best:true,
    tagline:"팀 단위 · 외국인 모델 에이전시 추천",
    features:["Pro 모든 기능","담당자 7명","외국인 세무 정산 포함","이메일 알림 · 구글 캘린더 동기화","알림톡·대량발송 (예정)","전담 우선 지원"] },
  { id:"enterprise", name:"Enterprise", price:228000, members:15, color:"#f59e0b", best:false,
    tagline:"중대형 · 모든 기능 포함",
    features:["Team 모든 기능","담당자 15명 (초과 ₩12,000/명)","외국인 세무 정산 포함","이메일 알림 · 구글 캘린더 동기화","알림톡·대량발송 (예정)","온보딩 설치·교육 지원","전담 고객 매니저"] },
];
...
export const PLAN_MATRIX: { group:string; rows:[string,string,string,string,string][] }[] = [
  ...
  { group:"커뮤니케이션", rows:[
    ["이메일 알림 (확정·취소·일정변동)","✓","✓","✓","✓"],
    ["구글 캘린더 동기화","✓","✓","✓","✓"],
    ["알림톡 (modiq 발송)","300건 (예정)","600건 (예정)","1,000건 (예정)","2,000건 (예정)"],
    ["세금계산서 발행 알림톡","예정","예정","예정","예정"],
    ["이메일 대량 발송 (AWS SES)","500건 (예정)","2,000건 (예정)","5,000건 (예정)","10,000건 (예정)"],
  ]},
  { group:"대대행", rows:[
    ["대대행 발신 (A역할)","–","✓","✓","✓"],
    ["대대행 수신 (B역할)","–","✓","✓","✓"],
