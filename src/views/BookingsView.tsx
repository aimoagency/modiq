        ...
        <div style={{ display:"grid", gap:8 }}>
          {filteredBookings.map(b=>(
            ...
            >
              ...
              <p style={{ flex:1, margin:0, fontSize:12, color:C.muted, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
                ...
                {b.project_name?<span style={{ color:C.blue }}> · <Folder size={11} style={{ verticalAlign:-2, flexShrink:0 }}/>{b.project_name}</span>:null}
